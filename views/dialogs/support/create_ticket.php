...
<form action="<?php echo (string)Url::to("/ccm/system/dialogs/social_icons_extended/create_ticket/submit"); ?>"
      data-dialog-form="create-ticket"
      method="post"
      enctype="multipart/form-data">

    <?php echo $form->hidden('projectHandle', "social_icons_extended"); ?>
