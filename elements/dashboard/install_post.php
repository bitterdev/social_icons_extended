...
<div class="row">
    <div class="col-xs-12">
        ...
        <a href="https://twitter.com/fabian_bitter?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false"><?php echo t("Follow @fabian_bitter"); ?></a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
    </div>
</div>
